...
route.get("/create", isLoggedIn, (req, res) => {
    res.render("user/createTeam");
})

//create team
route.post("/create", isLoggedIn, async (req, res) => {
...
//join to team
route.put("/notifications/:id/respond", isLoggedIn, async(req, res) => {
...
route.put("/notifications/:nId/markread", async(req, res) => {
  const Notification = require("../models/notification");
...
route.get("/searchTeams", async (req, res) => {
...
route.get("/inviteMembers", isLoggedIn, isLeader, async (req, res) => {
...
//send mail
route.post("/sendInviteMail", isLoggedIn, async (req, res) => {
...
route.get("/searchEmails", async (req, res) => {
  const query = req.query.q?.toLowerCase() || "";
  if (!query) return res.json([]);
...
route.get("/dashboard/team/:id", isLoggedIn, async(req, res) => {
